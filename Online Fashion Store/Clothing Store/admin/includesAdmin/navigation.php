  ...
  ?>
   <nav class="navbar navbar-expand-lg navbar-light bg-secondary navbar-fixed-top container-fluid" style="margin-top: -10px; position: fixed; z-index: 99;">
  <a class="navbar-brand" href="index.php?maincategory=fashion" style="color: red;">ADMIN</a>
 <?php 
...
<?php } ?>
 ...
 <div class="navbar-right" style="padding-left: 5px;">
     <button id ="myorders" class="btn btn-outline-dark my-2 my-sm-0" type="submit"><a href="addproduct.php?maincategory=<?php echo $maincategory;?>" class="text-dark">Add Product</a></button>
  </div>
